 ...
 */
final class Version20260108011644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE passager ADD nom VARCHAR(100) NOT NULL, ADD prenom VARCHAR(100) NOT NULL, CHANGE besoins_speciaux besoins_speciaux VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE telephone telephone VARCHAR(20) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE passager DROP nom, DROP prenom, CHANGE besoins_speciaux besoins_speciaux VARCHAR(255) DEFAULT \'NULL\'');
